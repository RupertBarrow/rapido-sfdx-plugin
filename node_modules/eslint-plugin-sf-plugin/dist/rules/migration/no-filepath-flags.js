...
exports.noFilepathFlags = void 0;
/*
...
exports.noFilepathFlags = utils_1.ESLintUtils.RuleCreator.withoutDocs({
    meta: {
        docs: {
            ...
            ? {
                Property(node) {
                    if ((0, flags_1.isFlag)(node) && (0, commands_1.ancestorsContainsSfCommand)(context.getAncestors())) {
                        const toReplace = (0, flags_1.getCalleePropertyByName)(node, 'filepath');
                        if (toReplace) {
                            context.report({
                                node: toReplace,
                                messageId: 'message',
