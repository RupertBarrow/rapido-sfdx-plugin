...
exports.extractMessageFlags = utils_1.ESLintUtils.RuleCreator.withoutDocs({
    meta: {
        docs: {
            ...
            ? {
                Property(node) {
                    ...
                    if (node.key.type === utils_1.AST_NODE_TYPES.Identifier &&
                        ...
                        const flag = ancestors.filter((0, ast_utils_1.isNodeOfType)(utils_1.AST_NODE_TYPES.Property)).find((a) => (0, flags_1.isFlag)(a));
